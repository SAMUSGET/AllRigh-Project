...
import com.icia.right.service.MService;
...
public class MController {
    ...
    public ModelAndView qDelete(@RequestParam("qNo") int qNo){
        mav = msvc.qDelete(qNo);
        return mav;
    }
    ...
    public ModelAndView revList(@RequestParam("reId") String reId){
        System.out.println("revList controller : " + reId);
