package com.icia.right.controller;

import com.icia.right.dto.QUESTION;
import com.icia.right.dto.RESERVE;
import com.icia.right.dto.REVIEW;
import com.icia.right.service.RService;
...
public class RController {
    ...
    public ModelAndView reviewForm(@RequestParam("rePname") String rePname) {
        System.out.println("==rePname==" + rePname);

        mav = rsvc.reviewForm(rePname);
        return mav;
    }
