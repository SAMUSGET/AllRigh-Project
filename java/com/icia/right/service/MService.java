package com.icia.right.service;

import com.icia.right.dao.MDAO;
...
public class MService {
    ...
    public ModelAndView mJoin(MEMBER member) throws IOException {
        ...
        String savePath = "C:/Users/jhlee/Desktop/final project/right/src/main/resources/static/profile/"+mLicenceName;
        // (6) 파일 선택여부
        if(!mLicence.isEmpty()){
    ...
    public ModelAndView qWrite(QUESTION question) throws IOException {
        ...
        String savePath = "C:/Users/jhlee/Desktop/final project/right/src/main/resources/static/profile/"+qFileName;
        // (6) 파일 선택여부
        if(!qFile.isEmpty()){
    ...
    // 문의 삭제 메소드
    public ModelAndView qDelete(int qNo) {
        int result = dao.qDelete(qNo);

        if(result > 0 ) {
            mav.setViewName("index");
        } else {
            mav.setViewName("redirect:/mqView?qNo="+qNo);
        }
    ...
    public ModelAndView reModify(REVIEW review) throws IOException {
        ...
        // (5) 파일 저장위치
        String savePath = "C:/Users/jhlee/Desktop/final project/right/src/main/resources/static/profile/"+reFileName;
